...
class ProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'item' => $this->when(
                request()->route()->named(['product.allProducts', 'product.allFilteredProducts','siteData.mostViewedProducts', 'products.newest','siteData.mostViewedProductsByCategory', 'all-advert', 'single-advert']),
